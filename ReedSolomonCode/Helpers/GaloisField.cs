...
namespace ReedSolomonCode.Helpers
{
    public class GaloisField
    {
        ...
        public static byte Divide(byte a, byte b)
        {
            ...
            if (LogTable[a] >= LogTable[b])
            {
                degree = (byte)(LogTable[a] - LogTable[b]);
            } else
            {
                degree = (byte)(255 - (byte)(LogTable[b] - LogTable[a]));
            }

            return ExpTable[degree];
        }
